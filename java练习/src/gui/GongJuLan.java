...
import javax.swing.JToolBar;
    ...
    public static void main(String[] args) {
        ...
        JButton b1 = new JButton(new ImageIcon("D:\\大学文件夹\\大二课程\\learnjava\\java练习\\picture\\1.jpg"));
        JButton b2 = new JButton(new ImageIcon("D:\\大学文件夹\\大二课程\\learnjava\\java练习\\picture\\2.jpg"));
        JButton b3 = new JButton(new ImageIcon("D:\\大学文件夹\\大二课程\\learnjava\\java练习\\picture\\3.jpg"));
        JButton b4 = new JButton(new ImageIcon("D:\\大学文件夹\\大二课程\\learnjava\\java练习\\picture\\4.jpg"));
        JButton b5 = new JButton(new ImageIcon("D:\\大学文件夹\\大二课程\\learnjava\\java练习\\picture\\5.jpg"));
        JButton b6 = new JButton(new ImageIcon("D:\\大学文件夹\\大二课程\\learnjava\\java练习\\picture\\6.jpg"));
        tb.add(b1);
        tb.add(b2);
        tb.add(b3);
        tb.add(b4);
